...
public interface TemplateService {
     ...
     *
     * @param emailTemplate a templateReference file to be processed. The name must be complaint with the position
     ...
     */
    String mergeTemplateIntoString(String emailTemplate, Map<String, Object> model)
